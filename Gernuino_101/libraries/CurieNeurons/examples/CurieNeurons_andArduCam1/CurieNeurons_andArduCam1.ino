// CurieNeurons_ArduCAM_Demo_1Feat
// Copyrights 2017, General Vision Inc.
//
//********************************************************************
//
...
// CurieNeurons or CurieNeuronsPro at http://www.general-vision.com/products/curieneurons/ 
...
//
// variables for the NeuroMem network
//
CurieNeurons hNN;
int dist=0, cat=0, nid=0, ncount=0;
int catLearn=1, nextCat=1;
#define MAX_LEN 128 // memory of a neuron, maximum length of the input patterns
byte neuron[MAX_LEN +8]; // to retrieve the content of an entire neuron
//
...
int vlen= hb*vb;
long subsample[121]; // buffer
byte subsampleFeat[121]; // byte array for the neurons
